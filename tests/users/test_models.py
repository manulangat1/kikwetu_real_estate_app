...
def test_user_str(base_user):
    """
    Test the custom user model string repre """
...
def test_base_user_email_is_normalizes(base_user):
    """
    Test the custom user model email is normalized """
    email = "manu@gkail.com"
